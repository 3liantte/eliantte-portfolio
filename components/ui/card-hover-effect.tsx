      ...
      {items.map((item, idx) => (
        ...
        >
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute inset-0 h-full w-full bg-gradient-to-br from-purple-500 via-cyan-400 to-white/20 block rounded-3xl"
          ...
          <Card>
            <div className="flex justify-center items-center mb-4">
              <div className="bg-white/10 dark:bg-white/20 p-3 rounded-full">
                {item.icon}
              </div>
            </div>
